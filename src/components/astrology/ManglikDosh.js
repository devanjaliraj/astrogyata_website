                ...
                <Card className="mb-50 pt-d">
                  ...
                  <div className="match-bx bg-white">
                    ...
                    <Row>
                      ...
                      {ManglikDosh?.manglik_cancel_rule > 0 ? (<><h3>Manglik Cancel Rule</h3>
                      ...
                      <span>{ManglikDosh?.percentage_manglik_after_cancellation}</span>

                      <h3>Percentage Manglik Present </h3>
                      <span>{ManglikDosh?.percentage_manglik_present}</span>

                      {ManglikDosh?.manglik_present_rule?.based_on_aspect == null ? null : (
                        <>
                          <h3>Manglik Present Rule</h3>
                          <h4 className="dosh">Based On Aspect</h4>
                          {ManglikDosh?.manglik_present_rule?.based_on_aspect?.map((value, i) => (
                            <p key={value?._id}>{i + 1}-{value}</p>
                          ))}</>
                      )}
                      {ManglikDosh?.manglik_present_rule?.based_on_house == null ? null : (
                        <>
                          {/* <h3>Manglik Present Rule</h3> */}
                          <h4 className="dosh">Based On House</h4>
                          {ManglikDosh?.manglik_present_rule?.based_on_house?.map((value, i) => (
                            <p key={value?._id}>{i + 1}-{value}</p>
                          ))}</>
                      )}
